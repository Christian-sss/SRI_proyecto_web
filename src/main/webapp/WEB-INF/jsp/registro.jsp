...
<head>
    ...
    <title>Sistema de Riego Inteligente - Registro</title>
...
<main class="login-shell">
    <section class="login-card">
        ...
        <form method="post" action="/registro" autocomplete="off">
            <div class="mb-3">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" id="username" name="username" class="form-control" placeholder="nuevo@sri.com" required autofocus>
                </div>
            </div>
            ...
            <a href="/login" class="btn btn-register w-100 mb-3 d-flex align-items-center justify-content-center text-decoration-none">
                Volver al Ingreso
            </a>
        </form>
        ...
        <div id="loginError" class="error-msg ${not empty error ? 'is-visible' : ''}">
            ...
            <span>${not empty error ? error : 'Error en el registro'}</span>
        </div>
    </section>
</main>
</body>
